...
import {IsEmail, IsNotEmpty, IsNumber, IsString, Length, Max, Min, Validate} from "class-validator";
...
export class UpdatePlayerDto extends UpdateMemberDto {
    ...
    @Min(0, {message: 'Number cannot be less than 0'})
